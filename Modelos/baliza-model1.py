...
@st.cache_data
def load_data():
    data = pd.read_csv(r"Modelos\baliza-model\train\results.csv")
    return data
...
def images():
    st.image(r"Modelos\baliza-model\val\val_batch0_labels.jpg")
    st.image(r"Modelos\baliza-model\val\val_batch0_pred.jpg")
